...
import hwg.bachelor.routesservice.repository.BusInfoRepository;
import hwg.bachelor.routesservice.repository.RoutesRepository;
...
public class RoutesService {
    ...
    public Routes findeById(String routeId){
        return routesRepository.findById(routeId).orElseThrow();
    }
